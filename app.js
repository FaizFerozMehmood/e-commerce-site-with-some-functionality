//1.Difference between traditional function and Arrow function
...
// let hello1 = name => "Hello " + name;

// console.log(hello1('Bilal'))

//Filter ka method

// array.forEach(function (data, ind) {
//   console.log("data=>", data);
// });
// var array = [32, 22, 11, 25, 23, 11, 53];

// var oddNums = array.filter((data, ind) => data % 2 == 1);
// var evenNums = array.filter((data, ind) => data % 2 == 0);
// var largerThe100 = array.filter((data, ind) => data > 100);
// console.log("oddNums=>", oddNums);
// console.log("evenNums=>", evenNums);
// console.log("largerThe30=>", largerThe100);
...
search_input.addEventListener("change", function () {
  var searched = products.filter((data, ind) =>
    data.title.toLowerCase().includes(this.value.toLowerCase())
  );
  container.innerHTML = "";
...
category_dropdown.addEventListener("change", function () {
  ...
  var categoryWiseProducts = products.filter(
    (data) => data.category == this.value
  );
  container.innerHTML = "";
...
// const filteredArray = arr.filter((data,index)=>)
  ...
  let filteredArray = users.filter((data,index)=>{
    return data.occupation==="teacher"||data.age ===5
  })
